        ...
        <div className="w-full min-h-full flex flex-col items-center justify-center p-4 md:p-8 relative overflow-hidden bg-black text-white py-20">
            ...
            <div className="flex-1 flex flex-col lg:flex-row items-center justify-center gap-8 md:gap-16 w-full max-w-7xl">
                ...
                <motion.div
                    ...
                    className="flex flex-col items-center gap-2 text-white/50 rotate-90 lg:rotate-0"
                >
                    <span className="text-[10px] font-mono tracking-widest uppercase">Render</span>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-green-500 w-8 h-8">
                ...
                {/* Right: Visual Output */}
                <div className="w-full max-w-[450px] aspect-[450/480] flex-shrink-0 flex items-center justify-center relative">
                    ...
                    >
                        <img
                            src={IMAGES.web}
                            alt="Web Poster"
                            className="h-full w-auto max-w-full object-contain shadow-2xl transition-all duration-500 ease-out hover:scale-105 hover:shadow-[0_0_60px_rgba(34,197,94,0.6)] hover:-translate-y-2 cursor-zoom-in"
                        />
                    </motion.div>
                </div>
            </div>
