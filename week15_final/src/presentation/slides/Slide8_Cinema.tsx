...
export const CinemaSlide: React.FC = () => {
    ...
    return (
        <div className="w-full min-h-full flex flex-col items-center justify-center p-4 md:p-8 relative overflow-hidden bg-black text-white py-20">
            ...
            <div className="flex-1 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-20 w-full max-w-7xl relative z-10">
                {/* Left: The Poster (Asymmetric/Larger) */}
                <motion.div
                    initial={{ x: -50, opacity: 0 }}
                    animate={{ x: 0, opacity: 1 }}
                    className="flex-shrink-0 w-full max-w-[300px] md:max-w-md"
                >
                    <div className="relative w-full aspect-[2/3] rounded-lg overflow-hidden shadow-[0_0_80px_rgba(220,38,38,0.4)] border-4 border-white/5 rotate-[-3deg] hover:rotate-0 transition-transform duration-700">
                        <img src={POSTER_URL} alt="Cinema Paradiso" className="h-full w-full object-cover" />
                ...
                <motion.div
                    ...
                    className="max-w-lg flex flex-col gap-8 text-left p-4 md:p-0"
                >
                    ...
                    <div className={`text-base md:text-xl leading-relaxed font-serif text-gray-400`}>
                        <p>
                    ...
                    <div className="text-[10px] md:text-xs font-mono opacity-40 uppercase tracking-[0.2em] mt-2 border-t border-white/10 pt-6">
